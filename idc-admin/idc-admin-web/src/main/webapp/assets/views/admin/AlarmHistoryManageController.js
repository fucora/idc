 ...
 */
angular.module('MetronicApp').controller('AlarmHistoryManageController', ['$scope', '$http', "$stateParams", 'NgTableParams', function ($scope, $http, $stateParams, NgTableParams) {
    ...
    $scope.tableParams = new NgTableParams({count: 20}, {
        ...
        getData: function (params) {
            ...
            var req = {
                method: 'post',
                url: '/admin/alarmHistoryManage/alarmHistoryTable',
                data: queryCondition
            };
