...
public class CommandResult implements org.apache.thrift.TBase<CommandResult, CommandResult._Fields>, java.io.Serializable, Cloneable, Comparable<CommandResult> {
  ...
  private static final org.apache.thrift.protocol.TField NEED_RETRY_FIELD_DESC = new org.apache.thrift.protocol.TField("needRetry", org.apache.thrift.protocol.TType.BOOL, (short)2);
  ...
  private static final int __NEEDRETRY_ISSET_ID = 1;
  ...
  public CommandResult setSucceed(boolean succeed) {
    this.succeed = succeed;
    setSucceedIsSet(true);
    return this;
  }
  ...
  public CommandResult setNeedRetry(boolean needRetry) {
    this.needRetry = needRetry;
    setNeedRetryIsSet(true);
    return this;
  }
