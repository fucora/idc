 ...
 */
@Component
public class IDCQuartzTriggerListener extends TriggerListenerSupport implements ApplicationContextAware {

	private static final Logger LOGGER = LoggerFactory.getLogger(IDCQuartzTriggerListener.class);
	...
	public void triggerFired(Trigger trigger, JobExecutionContext context) {
		...
		jobInstance.setDomain(job.getDomain());
		// TODO 参数信息
	...
	public String getName() {
		return IDCQuartzTriggerListener.class.getName();
	}
}
