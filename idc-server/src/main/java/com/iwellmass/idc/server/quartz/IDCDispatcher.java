...
public class IDCDispatcher implements org.quartz.Job {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(IDCDispatcher.class);
	
	private IDCJobLogger jobLogger;
	...
	// 使用 eureka 作为我们的执行器
	private void dispatcher(JobInstance jobInstance) {
